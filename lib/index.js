...
NefitEasyClient.prototype.queueMessage = function(message) {
  // Queue the request
...
NefitEasyClient.prototype.send = function(message, retries) {
  retries = retries || 0;
...
NefitEasyClient.prototype.get = function(uri, retries) {
